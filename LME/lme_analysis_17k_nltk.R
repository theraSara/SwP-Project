...
# ==========================================
df <- read.csv("data_output/master_modeling_data_17k_nltk.csv")
...
# ==========================================
print("Running Baseline (NLTK) and Human models...")
...
# ----------------- GPT-2 -----------------
sink("regression_output/gpt2_17k_nltk_effects.txt")
cat("\n================ UNIDIRECTIONAL - 17k NLTK ================\n")
print(summary(m_gpt2))
print("--- Does GPT-2 (UNI) using '17k NLTK' word dictionary improve over baseline? ---")
print(anova(m_base, m_gpt2))
print("--- Does GPT-2 (UNI) explain variance not captured by humans? ---")
print(anova(m_cloze, m_both_gpt2))

cat("\n================ BIDIRECTIONAL - 17k NLTK ================\n")
print(summary(m_gpt2_bi))
print("--- Does GPT-2 (BI) using '17k NLTK' word dictionary improve over baseline? ---")
...
# ----------------- GEMMA 270M -----------------
sink("regression_output/gemma270m_17k_nltk_effects.txt")
cat("\n================ UNIDIRECTIONAL - 17k NLTK ================\n")
print(summary(m_g270))
print("--- Does Gemma-270M (UNI) using '17k NLTK' word dictionary improve over baseline? ---")
...
print("--- Does Gemma-270M (BI) using '17k NLTK' word dictionary improve over baseline? ---")
...
# ----------------- GEMMA 12B -----------------
sink("regression_output/gemma12b_17k_nltk_effects.txt")
cat("\n================ UNIDIRECTIONAL - 17k NLTK ================\n")
print(summary(m_g12b))
print("--- Does Gemma-12B (UNI) using '17k NLTK' word dictionary improve over baseline? ---")
...
print("--- Does Gemma-12B (BI) using '17k NLTK' word dictionary improve over baseline? ---")
