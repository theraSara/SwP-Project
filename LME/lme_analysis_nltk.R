...
# ==========================================
df <- read.csv("data_output/master_modeling_data_nltk.csv")
...
# ----------------- GPT-2 -----------------
sink("regression_output/gpt2_nltk_effects.txt")
cat("\n================ UNIDIRECTIONAL - NLTK ================\n")
print(summary(m_gpt2))
print("--- Does GPT-2 (UNI) using 'NLTK' word dictionary improve over baseline? ---")
...
print("--- Does GPT-2 (BI) using 'NLTK' word dictionary improve over baseline? ---")
...
# ----------------- GEMMA 270M -----------------
sink("regression_output/gemma270m_nltk_effects.txt")
cat("\n================ UNIDIRECTIONAL - NLTK ================\n")
print(summary(m_g270))
print("--- Does Gemma-270M (UNI) using 'NLTK' word dictionary improve over baseline? ---")
...
print("--- Does Gemma-270M (BI) using 'NLTK' word dictionary improve over baseline? ---")
...
# ----------------- GEMMA 12B -----------------
sink("regression_output/gemma12b_nltk_effects.txt")
cat("\n================ UNIDIRECTIONAL - NLTK ================\n")
print(summary(m_g12b))
print("--- Does Gemma-12B (UNI) using 'NLTK' word dictionary improve over baseline? ---")
...
print("--- Does Gemma-12B (BI) using 'NLTK' word dictionary improve over baseline? ---")
